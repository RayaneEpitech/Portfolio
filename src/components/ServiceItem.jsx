...
function ServiceItem({title, icon, description}) {
  return (
    <div className='bg-slate-300 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 hover:-translate-y-2 transform transition p-5 rounded-md'>
        ...
        <h1 className='font-semibold text-lg text-gray-600 dark:text-gray-200 mb-2'>{title}</h1>
        <p className='text-md text-gray-600 dark:text-gray-300 whitespace-pre-line'>{description}</p>
    </div>
  )
}
